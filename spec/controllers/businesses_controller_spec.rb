...
describe BusinessesController do
  ...
  let(:valid_attributes) { { "outline" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved business as @business" do
        ...
        post :create, {:business => { "outline" => "invalid value" }}, valid_session
        assigns(:business).should be_a_new(Business)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested business" do
        ...
        Business.any_instance.should_receive(:update).with({ "outline" => "MyString" })
        put :update, {:id => business.to_param, :business => { "outline" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the business as @business" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Business.any_instance.stub(:save).and_return(false)
        put :update, {:id => business.to_param, :business => { "outline" => "invalid value" }}, valid_session
        assigns(:business).should eq(business)
      end
